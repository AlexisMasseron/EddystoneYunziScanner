...
EddystoneBeaconScanner.prototype.parseBeacon = function(peripheral) {
  ...
  var sensor_light = 100 * (light/31000); // Yunzi's light sensor goes from 0 to ~31000 so it represent light's maximum level
  var sensor_id = beacon.id; 
  var sensor_time = Date.now();
