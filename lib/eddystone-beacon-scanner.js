...
EddystoneBeaconScanner.prototype.parseBeacon = function(peripheral) {
  ...
  return {
	...
	sensor_motion: data2.readUInt8(18),
	sensor_light: 100*(data2.readUInt16BE(14)/25000),
	sensor_temp: (data.readUInt16BE(4)/256)-10,
	sensor_battery: data2.readUInt8(10),
...
EddystoneBeaconScanner.prototype.post = function() {
	var http = new WebSocket('http://localhost:8080');
	http.send(JSON.stringify(beacon, null, 2));
};
